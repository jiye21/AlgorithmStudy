...
3개의 눈이 6, 2, 5로 주어지면 그중 가장 큰 값이 6이므로 
...
int main()
{
    int diceN1, diceN2, diceN3;
    cin >> diceN1 >> diceN2 >> diceN3;

    if (diceN1 == diceN2 && diceN2 == diceN3) {
        cout << 10000 + diceN1 * 1000 << endl;
    }
    else if (diceN1 == diceN2 || diceN1 == diceN3)
    {
        cout << 1000 + diceN1 * 100 << endl;
    }
    else if (diceN2 == diceN3)
    {
        cout << 1000 + diceN2 * 100 << endl;
    }
    else 
    {
        cout << max(max(diceN1, diceN2), diceN3) * 100 << endl;
    }
